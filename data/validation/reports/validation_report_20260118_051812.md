...
### ✅ Monte Carlo KELIM Simulation

- **Robustness (at 10% noise CV):**
  - Correlation: 0.991 ✅
  - Category Accuracy: 36.20% ⚠️
...
| Noise CV | Correlation | Category Accuracy | Mean K Error |
|----------|-------------|-------------------|--------------|
| 0% | 1.000 | 35.50% | 23.587 |
| 5% | 0.997 | 36.00% | 22.910 |
| 10% | 0.991 | 36.20% | 23.544 |
| 15% | 0.979 | 37.70% | 24.038 |
| 20% | 0.958 | 38.60% | 23.780 |
